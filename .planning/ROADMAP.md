...
Plans:
- [x] 21-01-PLAN.md -- Install tinykeys, create useBladeMode hook, add splitScene mutation
- [x] 21-02-PLAN.md -- Blade button UI, visual mode indicator, click-to-split wiring
