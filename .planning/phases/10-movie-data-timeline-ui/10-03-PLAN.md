...
5. Drag a scene to reorder -- it moves smoothly without flicker, remains in new position after mutation completes (no snap-back)
6. Click the X on a scene to remove it -- scene disappears and stats update
7. Refresh the page -- all changes persist (reorder, add, remove all survived)
  </verify>
  <done>
