...
must_haves:
  truths:
    ...
    - "User can access /create and /templates at the same URLs with sidebar visible"
  artifacts:
...
2. Verify old files are gone: `test ! -f src/app/create/page.tsx && test ! -f src/app/templates/page.tsx && echo "Old files removed"` should print "Old files removed"
