...
<task type="auto">
  <name>Task 1: Install shadcn components and create template definitions</name>
  <files>
    src/lib/templates.ts
  </files>
  <action>
...
2. Create `src/lib/templates.ts` with:
  ...
  <done>
    8 templates defined with proper types, helper functions exported, shadcn tabs/dialog installed
  </done>
</task>

<task type="auto">
  <name>Task 2: Create template gallery components</name>
  <files>
    src/components/templates/template-card.tsx
    src/components/templates/template-preview.tsx
    src/components/templates/template-gallery.tsx
