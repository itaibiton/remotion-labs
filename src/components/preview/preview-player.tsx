...
import { TextAnimation, type TextAnimationProps } from "@/remotion/compositions/TextAnimation";
...
function PreviewPlayerInner({ animationProps }: PreviewPlayerProps) {
...
export function PreviewPlayer({ animationProps }: PreviewPlayerProps) {
  ...
  return <PreviewPlayerInner animationProps={animationProps} />;
}
