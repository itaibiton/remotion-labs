...
export function GenerationRow({ generation, onSelect }: GenerationRowProps) {
  ...
  return (
    <button
      type="button"
      className="w-full flex flex-row gap-4 p-3 rounded-lg border hover:bg-muted/50 transition-colors text-left"
